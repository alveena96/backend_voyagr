...
SECRET_KEY = 'django-insecure-(x9%)91jc8u35%%m(n)4ls@8jm5p&ihopbni87kt=j8)+_y*w3'

# ***********************************************************************************
#                           CORS ORIGIN AND DEBUG SYSTEM 
# ***********************************************************************************
DEBUG = True
...
CSRF_TRUSTED_ORIGINS = [
    "http://localhost:3000",
    "https://rda.ngrok.app",
    "https://tallowy-unplacatory-britta.ngrok-free.dev"
]
...
MAX_TOKEN_LIFETIME = timedelta(days=36500)  
